...
{% assign posts_after_date = site.posts | where: "date", ">=", "2023-12-20" %}
전체 아카이브:{{ posts_after_date.size }}개
...
{% assign i = 0 %}
{% for post in posts_after_date %}{% assign post_date = post.date | date: "%Y-%m-%d" %}{% assign year = post.date | date: page.jekyll-theme-WuK.archive.group_by, "" %}{% assign nyear = post.next.date | date: page.jekyll-theme-WuK.archive.group_by, "" %}{% if year != nyear %}
